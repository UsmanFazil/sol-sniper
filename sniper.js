...
const { apiSwap } = require(path.resolve(__dirname, './src/api/swap.ts'));
...
async function fetchRaydiumMints(txId, connection) {
    try {
        ...
        apiSwap({
            inputMint: tokenBAccount.toBase58(), // SOL
            outputMint: tokenAAccount.toBase58(), // Your token
            amount: 0.02 * 1e9, // Optional: 0.02 SOL
            slippage: 0.3       // Optional: 0.3%
          })
